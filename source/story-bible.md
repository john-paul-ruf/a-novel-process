...
| Ch 8 "Enough, now" reference | Ch 8 draft lines 57-58 and 129 reference Elena's final entry "Enough, now" | Ch 8 | Per outline, Elena's Year One logs end with "We're going to make it." (Ch 8 turn). "Enough, now" belongs exclusively to Ch 23. Ch 8 draft needs revision to remove premature revelation. |
